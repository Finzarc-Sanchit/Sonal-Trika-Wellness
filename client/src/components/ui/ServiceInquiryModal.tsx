...
export default function ServiceInquiryModal({
  ...
  const serviceLabel = serviceSlug ? formatContactService(serviceSlug) : 'this service';
      ...
      {isOpen && serviceSlug && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-3 top-[8vh] z-[100] max-h-[84vh] overflow-hidden rounded-2xl border border-[#D8C5A4]/50 bg-[#F8F5F0] shadow-2xl md:inset-x-auto md:left-1/2 md:w-[min(520px,calc(100vw-2rem))] md:-translate-x-1/2"
