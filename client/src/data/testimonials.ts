...
export const VIDEO_TESTIMONIALS: VideoTestimonial[] = [
  {
    ...
    posterSrc:
      'https://res.cloudinary.com/dfvj8gw1g/video/upload/f_auto,q_auto,so_1/v1781676980/client-story_jgydlr.jpg',
    videoSrc:
      'https://res.cloudinary.com/dfvj8gw1g/video/upload/f_auto,q_auto/v1781676980/client-story_jgydlr.mp4',
  },
  {
    id: 'piyush',
    name: 'Piyush',
    ...
    posterSrc:
      'https://res.cloudinary.com/dfvj8gw1g/video/upload/f_auto,q_auto,so_1/v1781677051/piyush_zdctgs.jpg',
    videoSrc:
      'https://res.cloudinary.com/dfvj8gw1g/video/upload/f_auto,q_auto/v1781677051/piyush_zdctgs.mp4',
  },
  {
    id: 'anju-sound-healing',
    name: 'Anju Sound Healing',
    designation: 'Group Sound Healing Client',
    headline: 'What happens when you finally allow yourself to pause',
    posterSrc:
      'https://res.cloudinary.com/dfvj8gw1g/video/upload/f_auto,q_auto,so_1/v1781677045/anju-sound-healing_r2mt3e.jpg',
    videoSrc:
      'https://res.cloudinary.com/dfvj8gw1g/video/upload/f_auto,q_auto/v1781677045/anju-sound-healing_r2mt3e.mp4',
  },
];
