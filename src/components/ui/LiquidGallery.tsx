  ...
  return (
    ...
    >
      ...
      <div className="liquid-gallery-mask bg-gradient-to-t from-[#1A1A1A] via-[#1A1A1A]/40 to-transparent">
        <p className="mb-4 font-sans text-[11px] font-semibold uppercase tracking-[0.2em] text-[#878384]">
      ...
      <div className="liquid-gallery-cta-bar">
        <button
          ...
          className="px-6 py-2.5 bg-[#F8F5F0] text-[#2B2B2B] font-sans text-[11px] font-semibold uppercase tracking-[0.15em] hover:bg-white transition-colors duration-300 cursor-pointer"
        >
          {item.primaryCta}
        </button>
        {item.secondaryCta && (
          <button
            ...
            className="font-sans text-[11px] font-semibold uppercase tracking-[0.15em] text-[#F8F5F0] border-b border-[#F8F5F0] pb-1 hover:text-white hover:border-white transition-all cursor-pointer"
          >
            {item.secondaryCta}
          </button>
        )}
